...
public class EllipseProgramNodeContribution implements ProgramNodeContribution {
	...
	private void configureWaypointNodes(Pose centerPose, JointPositions jointPositions) {
		...
		for (WaypointNode waypointNode : waypointNodes) {
			...
			WaypointNodeConfig newWaypointNodeConfig = createWaypointConfig(centerPose, jointPositions, offsetX,
					offsetY, offsetZ);
	...
	private WaypointNodeConfig createWaypointConfig(Pose centerPose, JointPositions jointPositions, double xOffsetInMM,
		...
		return waypointNodeConfigFactory.createFixedPositionConfig(pose, jointPositions, blendParameters,
				motionParameters);
	}
	...
	private void configureMoveNode() {
		...
		MovePMotionParameters motionParameters = moveNode.getConfigFactory().createMovePMotionParameters(speed,
				ErrorHandler.AUTO_CORRECT, acceleration, ErrorHandler.AUTO_CORRECT, blend, ErrorHandler.AUTO_CORRECT);
